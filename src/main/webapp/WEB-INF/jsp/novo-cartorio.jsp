...
<head>
    ...
    <title>Cadastro de Cartorios</title>
...
<body>
    <div>
       <div id="topo">
        <p class="titulo">Cadastro de novo Cartório</p>
            <hr/>
        </div>
        <div id="conteudo">
            <div>
                <form:form action="/add" modelAttribute="cartorio" method="post">
                    <div>
                        <div>
                    ...
                    <div>
                        <div>
                            <button type="submit" class="btn-acoes">Salvar</button>
                        </div>
                    </div>
                </form:form>
            </div>
